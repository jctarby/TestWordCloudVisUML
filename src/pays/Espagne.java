...
public class Espagne {

    private String unlongnomquineseerrtarien;

    public Espagne() {
    }

    /**
     * Histoire de l'Espagne (wikipedia)
